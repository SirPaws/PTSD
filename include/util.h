...
#define pGetTimeNanoSeconds(rettype, timepoint) \
    (rettype)_Generic((rettype)0, \
        f128: pGetTimeNanold, f64: pGetTimeNanod, f32: pGetTimeNanof,\
...
#define pGetTimeMiliSeconds(rettype, timepoint) \
    (rettype)_Generic((rettype)0, \
        f128: pGetTimeMilild, f64: pGetTimeMilid, f32: pGetTimeMilif,\
...
static inline f128 pGetTimeNanold(pTimePoint timepoint) { return (f128)timepoint; }
...
static inline f128 pGetTimeMilild(pTimePoint timepoint) { return (f128)timepoint / (f128)1000000; }
...
static inline f128 pGetTimeSecondsld(pTimePoint timepoint) { return (f128)timepoint / (f128)1000000000; }
